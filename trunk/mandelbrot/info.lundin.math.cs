		...
		toValue( Node tree ) 
		{
		  ...
		  if( tree.arguments() == 2 )
		  {
			...
			if( op.Equals( "+" ) )
			    ...
			    return( Complex.Pow(toValue(arg1),toValue(arg2)));
			else if( op.Equals( "log" ) )
                return (Complex.Log(toValue(arg2)) / Complex.Log(toValue(arg1)));
			else if( op.Equals( "%" ) )
			    return( toValue(arg1).Real % toValue(arg2).Real); 
			else if( op.Equals( "==" ) )
			    return( toValue(arg1) == toValue(arg2) ? 1.0 : 0.0 );
			else if( op.Equals( "!=" ) )
			    return( toValue(arg1) != toValue(arg2) ? 1.0 : 0.0  );
			else if( op.Equals( "<" ) )
                return (toValue(arg1).Magnitude < toValue(arg2).Magnitude ? 1.0 : 0.0);
			else if( op.Equals( ">" ) )
                return (toValue(arg1).Magnitude > toValue(arg2).Magnitude ? 1.0 : 0.0);
			else if( op.Equals( "&&" ) )
		  ...
		  {
			if( op.Equals( "sqrt" ) )
			    return( Complex.Pow(toValue(arg1) , 0.5 ));
			else if( op.Equals( "sin" ) )
                return (Complex.Sin(toValue(arg1)));
			else if( op.Equals( "cos" ) )
                return (Complex.Cos(toValue(arg1)));
			else if( op.Equals( "tan" ) )
                return (Complex.Tan(toValue(arg1)));
			else if( op.Equals( "asin" ) )
                return (Complex.Asin(toValue(arg1)));
			else if( op.Equals( "acos" ) )
                return (Complex.Acos(toValue(arg1)));
			else if( op.Equals( "atan" ) )
                return (Complex.Atan(toValue(arg1)));
			else if( op.Equals( "ln" ) )
                return (Complex.Log(toValue(arg1)));
			else if( op.Equals( "exp" ) )
                return (Complex.Exp(toValue(arg1)));
			else if( op.Equals( "cotan" ) )
                return (1 / Complex.Tan(toValue(arg1)));
			else if( op.Equals( "acotan" ) )
                return (Math.PI / 2 - Complex.Atan(toValue(arg1)));
			else if( op.Equals( "ceil" ) )
			    return((double)Math.Ceiling(toValue(arg1).Magnitude));
			else if( op.Equals( "round" ) )
			    return((double)Math.Round(toValue(arg1).Magnitude));
			else if( op.Equals( "floor" ) )
			    return((double)Math.Floor(toValue(arg1).Magnitude));
			else if( op.Equals( "fac" ) )
			    return(fac(toValue(arg1).Magnitude));
			else if( op.Equals( "abs" ) )
			    return( Math.Abs(toValue(arg1).Magnitude));
			else if( op.Equals( "fpart" ) )
			    return( fpart(toValue(arg1).Magnitude) );
			else if( op.Equals( "sfac" ) )
			    return( sfac(toValue(arg1).Magnitude));
			else if( op.Equals( "sinh" ) )
			{
                return Complex.Sinh(toValue(arg1));
			}
			else if( op.Equals( "cosh" ) )
			{
                return Complex.Cosh(toValue(arg1));
			}
			else if( op.Equals( "tanh" ) )
			{
                return Complex.Tanh(toValue(arg1));
			}
			else if( op.Equals( "!" ) )
			{
